...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Fullscreen immersive automotive HUD mode (No title bar, No status bar)
        ...
        // Hardware Camera and Audio Permissions for In-Car Dashcam & Voice Alerts
